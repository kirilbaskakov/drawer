...
import { DEFAULT_STYLES, LINE_DASH, LINE_WIDTHS, STROKE_COLORS } from "../constants/drawingDefaults";
    ...
    <div className="toolbar toolbar-top-left">
      <Picker
        ...
        options={STROKE_COLORS.map(color => ({
            icon: <div className="custom-tool-icon" style={{backgroundColor: color}}/>,
            value: color
        }))}
      ...
      <Picker
        ...
        options={LINE_WIDTHS.map((width, index) => ({
            icon: <div className="custom-tool-icon">
                    <div className="line-width-icon" style={{borderTopWidth: (index + 1) * 2}}/>
                  </div>,
            value: width
        }))}
      ...
      <Picker
        ...
        options={LINE_DASH.map((dash) => ({
            icon: <div className="custom-tool-icon">
                    <div className="line-width-icon" style={{borderStyle: dash[0] ? "dashed" : "solid"}}/>
                  </div>,
            value: dash
        }))}
